...
<head>
    ...
    <!-- trình văn bản -->
    <script src="https://cdn.tiny.cloud/1/s7eqmu75v4qmxi2wtlfvidzc2yfdd6yz5ayeto77x7fi6ft6/tinymce/6/tinymce.min.js"
            ...
            <div class="nav-right ">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{ url('admin/user/info') }}">Tài khoản</a>
        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active == 'ads' ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ url('admin/ads/add') }}">Thêm mới</a></li>
                            <li><a href="{{ url('admin/ads/list') }}">Danh sách</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
