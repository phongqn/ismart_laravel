...
class AdminProductController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        if ($status == 'trash') {
            ...
            $products = Product::where('name', 'LIKE', "%{$keyword}%")->where('status', '1')->paginate(10);
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('product_thumb')) {
            ...
            $file->move('admin/uploads/product', $fileName . '.' . $file_ex);
            $thumbnail = 'admin/uploads/product/' . $fileName . '.' . $file_ex;
        }
        ...
        if ($request->hasFile('product_thumbs')) {
            ...
            foreach ($files as $file) {
                $fileName = $file->getClientOriginalName();
                $filePath =  $file->move('admin/uploads/product', $fileName);
                ProductThumb::create([
